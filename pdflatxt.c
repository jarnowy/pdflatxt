...
if (ISOEnc) {
    ...
    /* Windows-1252 extra block 0x80–0x9F */
    writestr("/Euro /.notdef /quotesinglbase /florin /quotedblbase\n");
    writestr("/ellipsis /dagger /daggerdbl /circumflex /perthousand\n");
    writestr("/Scaron /guilsinglleft /OE /.notdef /Zcaron /.notdef\n");
    writestr("/.notdef /quoteleft /quoteright /quotedblleft /quotedblright\n");
    writestr("/bullet /endash /emdash /tilde /trademark /scaron\n");
    writestr("/guilsinglright /oe /.notdef /zcaron /Ydieresis\n");
    ...
    writestr("/Encoding <<\n");
    writestr("/Differences [ 128\n");

    writestr("/Ccedilla /udieresis /eacute /acircumflex /adieresis /agrave /aring /ccedilla\n");
    writestr("/ecircumflex /edieresis /egrave /idieresis /icircumflex /igrave /Adieresis /Aring\n");
    writestr("/Eacute /ae /AE /ocircumflex /odieresis /ograve /ucircumflex /ugrave\n");
    writestr("/ydieresis /Odieresis /Udieresis /oslash /sterling /Oslash /multiply /florin\n");
    writestr("/aacute /iacute /oacute /uacute /ntilde /Ntilde /ordfeminine /ordmasculine\n");
    writestr("/questiondown /registered /logicalnot /onehalf /onequarter /exclamdown /guillemotleft /guillemotright\n");
    writestr("/ltshade /mdshade /dkshade /uni2502 /uni2524 /Aacute /Acircumflex /Agrave\n");
    writestr("/copyright /uni2563 /uni2551 /uni2557 /uni255D /cent /yen /uni2510\n");
    writestr("/uni2514 /uni2534 /uni252C /uni251C /uni2500 /uni253C /atilde /Atilde\n");
    writestr("/uni255A /uni2554 /uni2569 /uni2566 /uni2560 /uni2550 /uni256C /currency\n");
    writestr("/eth /Eth /Ecircumflex /Edieresis /Egrave /Euro /Iacute /Icircumflex\n");
    writestr("/Idieresis /uni2518 /uni250C /block /dnblock /brokenbar /Igrave /uni2580\n");
    writestr("/Oacute /germandbls /Ocircumflex /Ograve /otilde /Otilde /uni00B5 /thorn\n");
    writestr("/Thorn /Uacute /Ucircumflex /Ugrave /yacute /Yacute /macron /acute\n");
    writestr("/uni00AD /plusminus /doublelowline /threequarters /paragraph /section /divide /cedilla\n");
    writestr("/degree /dieresis /periodcentered /onesuperior /threesuperior /twosuperior /uni25A0 /uni00A0\n");
